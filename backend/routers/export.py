...
async def download_journal_template():
    ...
    ws = wb.active
    ws.title = "序时账"
    ws.append(["核算组织", "记账日期", "期间", "凭证号", "摘要", "科目编码", "科目名称", "借方", "贷方", "核算维度"])
    ws.append(["XX公司", "2026-01-15", "2026年1期", "0001", "计提工资", "6602.18", "管理费用_审计咨询费", 10000, "", "部门:综合部"])
    ws.append(["XX公司", "2026-01-15", "2026年1期", "0001", "计提工资", "2211.02", "应付职工薪酬_奖金", "", 10000, ""])
    stream = BytesIO()
    wb.save(stream)
    stream.seek(0)
